...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterVPNRole) DeepCopyInto(out *ClusterVPNRole) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterVPNRole.
func (in *ClusterVPNRole) DeepCopy() *ClusterVPNRole {
	if in == nil {
		return nil
	}
	out := new(ClusterVPNRole)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TopologyConfig) DeepCopyInto(out *TopologyConfig) {
	*out = *in
	if in.CustomConnections != nil {
		in, out := &in.CustomConnections, &out.CustomConnections
		*out = make([]ClusterConnection, len(*in))
		copy(*out, *in)
	}
	if in.ClusterVPNRoles != nil {
		in, out := &in.ClusterVPNRoles, &out.ClusterVPNRoles
		*out = make([]ClusterVPNRole, len(*in))
		copy(*out, *in)
	}
}
